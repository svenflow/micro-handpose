...
`);function xe(o,_){return Wa.replace("@compute @workgroup_size(8,8,1)",`@compute @workgroup_size(${o},${_},1)`)}function ve(o,_){return Ha.replace("@compute @workgroup_size(8,8,1)",`@compute @workgroup_size(${o},${_},1)`)}function Pe(o,_){return La.replace("@compute @workgroup_size(8,8,1)",`@compute @workgroup_size(${o},${_},1)`)}function ke(o,_){return Ta.replace("@compute @workgroup_size(8,8,1)",`@compute @workgroup_size(${o},${_},1)`)}function Be(o,_){return[8,8]}var Ue=P(`
...
`)}var He=Me("sigmoid"),We=Me("div256"),Le=P(`
@group(0)@binding(0) var<storage,read> input:array<f32>;
...
`);function Ie(o,_){let n=new Map,m=o.dtype??"float32";for(let c=0;c<o.keys.length;c++){let W=o.keys[c],p=o.shapes[c],D=o.offsets[c],A=p.reduce((b,u)=>b*u,1),B;if(m==="float32")B=new Float32Array(_,D,A);else{let b=new DataView(_);B=new Float32Array(A);for(let u=0;u<A;u++)B[u]=xt(b.getUint16(D+u*2,!0))}n.set(W,{data:B,shape:p})}return n}function xt(o){let _=o>>15&1,n=o>>10&31,m=o&1023;if(n===0){if(m===0)return _?-0:0;let p=-14,D=m/1024;return(_?-1:1)*Math.pow(2,p)*D}if(n===31)return m===0?_?-1/0:1/0:NaN;let c=n-15,W=1+m/1024;return(_?-1:1)*Math.pow(2,c)*W}var vt=[[24,24,128,1,"backbone1.3.f.0."],[24,24,128,1,"backbone1.3.f.1."],[24,48,128,2,"backbone1.4."],[48,48,64,1,"backbone2.0.f.0."],[48,48,64,1,"backbone2.0.f.1."],[48,96,64,2,"backbone2.1."],[96,96,32,1,"backbone3.0.f.0."],[96,96,32,1,"backbone3.0.f.1."],[96,96,32,2,"backbone3.1."],[96,96,16,1,"backbone4.0.f.0."],[96,96,16,1,"backbone4.0.f.1."],[96,96,16,2,"backbone4.1."],[96,96,16,1,"backbone5.0."],[96,96,32,1,"backbone6.0."],[48,48,64,1,"ff.0.f.0."],[48,48,64,1,"ff.0.f.1."],[48,48,64,1,"ff.0.f.2."],[48,48,64,1,"ff.0.f.3."],[48,96,64,2,"ff.1."],[96,96,32,1,"ff.2.f.0."],[96,96,32,1,"ff.2.f.1."],[96,96,32,1,"ff.2.f.2."],[96,96,32,1,"ff.2.f.3."],[96,288,32,2,"ff.3."],[288,288,16,1,"ff.4.f.0."],[288,288,16,1,"ff.4.f.1."],[288,288,16,1,"ff.4.f.2."],[288,288,16,1,"ff.4.f.3."],[288,288,16,2,"ff.5."],[288,288,8,1,"ff.6.f.0."],[288,288,8,1,"ff.6.f.1."],[288,288,8,1,"ff.6.f.2."],[288,288,8,1,"ff.6.f.3."],[288,288,8,2,"ff.7."],[288,288,4,1,"ff.8.f.0."],[288,288,4,1,"ff.8.f.1."],[288,288,4,1,"ff.8.f.2."],[288,288,4,1,"ff.8.f.3."],[288,288,4,2,"ff.9."],[288,288,2,1,"ff.10.f.0."],[288,288,2,1,"ff.10.f.1."],[288,288,2,1,"ff.10.f.2."],[288,288,2,1,"ff.10.f.3."]],Oe=vt.map(([o,_,n,m,c])=>({type:"resmodule",inCh:o,outCh:_,h:n,w:n,stride:m,prefix:c})),Pt=2,kt=5,Bt=8,Ut=11;async function ze(o){if(!navigator.gpu)throw new Error("WebGPU not supported");let _=await navigator.gpu.requestAdapter();if(!_)throw new Error("No GPU adapter found");let n=await _.requestDevice(),m={r:"read-only-storage",s:"storage",u:"uniform"};function c(e){return n.createBindGroupLayout({entries:e.map((s,i)=>({binding:i,visibility:GPUShaderStage.COMPUTE,buffer:{type:m[s]}}))})}function W(e){return n.createBindGroupLayout({entries:e.map((s,i)=>s==="t"?{binding:i,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"float"}}:{binding:i,visibility:GPUShaderStage.COMPUTE,buffer:{type:m[s]}})})}let p=GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,D=GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC,A=GPUBufferUsage.STORAGE,B=GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC,b=GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST;function u(e,s){return n.createBuffer({size:e,usage:s})}function w(e,s){return n.createBindGroup({layout:e,entries:s.map((i,t)=>({binding:t,resource:"size"in i?{buffer:i}:i}))})}function x(e,s){return n.createComputePipeline({layout:n.createPipelineLayout({bindGroupLayouts:[e]}),compute:{module:s,entryPoint:"main"}})}let Q=n.createShaderModule({code:Ue}),aa=n.createShaderModule({code:Re}),ea=n.createShaderModule({code:Le}),ta=n.createShaderModule({code:Wa}),y=n.createShaderModule({code:Ha}),S=n.createShaderModule({code:La}),k=n.createShaderModule({code:Ta}),z=n.createShaderModule({code:De}),ia=n.createShaderModule({code:Ge}),F=n.createShaderModule({code:Ce}),L=n.createShaderModule({code:Ae}),Fe=n.createShaderModule({code:Ee}),Ne=n.createShaderModule({code:He}),qe=n.createShaderModule({code:We}),Ye=n.createShaderModule({code:Te}),na=c(["r","r","r","s","u"]),ra=c(["r","r","r","r","s","u"]),Ra=c(["r","s","u"]),Oa=c(["r","r","r","s","u"]),Xe=c(["r","s","u"]),$e=c(["r","r","s","u"]),N=c(["r","r","s","u"]),Ia=c(["r","r","r","s","u"]),O=c(["r","r","r","s","u"]),za=W(["t","s","u"]),Fa=c(["r","r","r","r","r","r","r","s","s","s"]),sa=c(["r","r","r","r","r","s","u"]),Ze=n.createPipelineLayout({bindGroupLayouts:[na]}),Ve=n.createPipelineLayout({bindGroupLayouts:[ra]}),q=e=>n.createComputePipeline({layout:Ze,compute:{module:e,entryPoint:"main"}}),Y=e=>n.createComputePipeline({layout:Ve,compute:{module:e,entryPoint:"main"}}),je=q(ta),Ke=q(y),Je=Y(S),Qe=Y(k),Na=new Map,qa=new Map,Ya=new Map,Xa=new Map;Na.set("8,8",je),qa.set("8,8",Ke),Ya.set("8,8",Je),Xa.set("8,8",Qe);function X(e,s,i,t,a){let f=`${s},${i}`,d=e.get(f);return d||(d=a(n.createShaderModule({code:t(s,i)})),e.set(f,d)),d}let at=(e,s)=>X(Na,e,s,xe,q),et=(e,s)=>X(qa,e,s,ve,q),tt=(e,s)=>X(Ya,e,s,Pe,Y),it=(e,s)=>X(Xa,e,s,ke,Y),T=Oe.map(e=>{let s=e.stride===2?e.h/2:e.h,i=e.stride===2?e.w/2:e.w,[t,a]=Be(e.inCh,s),f=e.h>=64,d=s>=16&&e.inCh>=288&&e.outCh>=288&&e.outCh%2===0;return{dwPipeline:f?et(t,a):at(t,a),pwPipeline:d?it(t,a):tt(t,a),dwDispatchX:Math.ceil(i/t),dwDispatchY:Math.ceil(s/a),dwDispatchZ:e.inCh,pwDispatchX:Math.ceil(i/t),pwDispatchY:Math.ceil(s/a),pwDispatchZ:d?e.outCh/2:e.outCh}}),$a=x(Ra,Q),nt=x(Oa,z);x(Xe,ia),x($e,F);let ua=x(N,L),rt=x(Ia,Fe);x(O,Ne),x(O,qe);let Za=x(za,aa),st=x(Fa,ea),ut=x(sa,Ye),oa=1*288*128*128*4,Va=u(3*256*256*4,p),pa=u(3*257*257*4,A),ja=u(12,b);n.queue.writeBuffer(ja,0,new Uint32Array([3,256,257]));let g=u(oa,D),U=u(oa,B),$=u(oa,A),Ka=u(3072*64*4,p),Ja=u(3072*32*4,p),Qa=u(1536*16*4,p),ae=u(6144*64*4,A),_a=u(4,B),da=u(4,B),ca=u(252,B),G=u(260,GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST);u(260,GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST);let wa=n.createTexture({size:[256,256],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),ee=u(8,b);n.queue.writeBuffer(ee,0,new Uint32Array([256,257]));let la=o.get("backbone1.1.weight")?.data,ha=o.get("backbone1.1.bias")?.data;if(!la||!ha)throw new Error("Missing input conv weights");let te=u(la.byteLength,p),ie=u(ha.byteLength,p),ne=u(28,b);n.queue.writeBuffer(te,0,la),n.queue.writeBuffer(ie,0,ha),n.queue.writeBuffer(ne,0,new Uint32Array([1,3,24,257,257,128,128]));let ma=o.get("backbone6.1.weight")?.data,fa=o.get("backbone6.1.bias")?.data;if(!ma||!fa)throw new Error("Missing backbone6.1 conv1x1 weights");let re=u(ma.byteLength,p),se=u(fa.byteLength,p),ue=u(20,b);n.queue.writeBuffer(re,0,ma),n.queue.writeBuffer(se,0,fa),n.queue.writeBuffer(ue,0,new Uint32Array([1,96,48,32,32]));let ba=o.get("handflag.weight")?.data,ga=o.get("handflag.bias")?.data;if(!ba||!ga)throw new Error("Missing handflag weights");let ya=u(ba.byteLength,p),xa=u(ga.byteLength,p),oe=u(12,b);n.queue.writeBuffer(ya,0,ba),n.queue.writeBuffer(xa,0,ga),n.queue.writeBuffer(oe,0,new Uint32Array([1,288,1]));let va=o.get("handedness.weight")?.data,Pa=o.get("handedness.bias")?.data;if(!va||!Pa)throw new Error("Missing handedness weights");let ka=u(va.byteLength,p),Ba=u(Pa.byteLength,p),pe=u(12,b);n.queue.writeBuffer(ka,0,va),n.queue.writeBuffer(Ba,0,Pa),n.queue.writeBuffer(pe,0,new Uint32Array([1,288,1]));let Ua=o.get("reg_3d.weight")?.data,Da=o.get("reg_3d.bias")?.data;if(!Ua||!Da)throw new Error("Missing reg_3d weights");let Sa=u(Ua.byteLength,p),Ga=u(Da.byteLength,p),_e=u(12,b);n.queue.writeBuffer(Sa,0,Ua),n.queue.writeBuffer(Ga,0,Da),n.queue.writeBuffer(_e,0,new Uint32Array([1,288,63]));let I=Oe.map(e=>{let{inCh:s,outCh:i,h:t,w:a,stride:f,prefix:d}=e,v=f===2?t/2:t,l=f===2?a/2:a,h=f===1?2:1,r=o.get(`${d}convs.0.weight`)?.data,Ca=o.get(`${d}convs.0.bias`)?.data,Ea=o.get(`${d}convs.1.weight`)?.data,Ma=o.get(`${d}convs.1.bias`)?.data;if(!r||!Ca||!Ea||!Ma)throw new Error(`Missing weights for ${d}`);let he=u(r.byteLength,p),me=u(Ca.byteLength,p),fe=u(Ea.byteLength,p),be=u(Ma.byteLength,p),ge=u(32,b),ye=u(36,b);return n.queue.writeBuffer(he,0,r),n.queue.writeBuffer(me,0,Ca),n.queue.writeBuffer(fe,0,Ea),n.queue.writeBuffer(be,0,Ma),n.queue.writeBuffer(ge,0,new Uint32Array([1,s,t,a,v,l,f,h])),n.queue.writeBuffer(ye,0,new Uint32Array([1,s,i,v,l,Math.max(0,i-s),f,t,a])),{dwWeight:he,dwBias:me,pwWeight:fe,pwBias:be,dwUniform:ge,pwUniform:ye,spec:e,outH:v,outW:l}});function R(e){let s=u(e.length*4,b);return n.queue.writeBuffer(s,0,new Uint32Array(e)),s}let ot=R([1,96,8,8,16,16]),pt=R([1,96,16,16,32,32]),_t=R([1,48,32,32,64,64]);R([1536*16]),R([3072*32]),R([3072*64]);let de=w(Ra,[Va,pa,ja]),dt=w(Oa,[pa,te,ie,g,ne]),C=[],E=[],M=[],H=[];for(let e of I)C.push(w(na,[g,e.dwWeight,e.dwBias,$,e.dwUniform])),E.push(w(ra,[$,g,e.pwWeight,e.pwBias,U,e.pwUniform])),M.push(w(na,[U,e.dwWeight,e.dwBias,$,e.dwUniform])),H.push(w(ra,[$,U,e.pwWeight,e.pwBias,g,e.pwUniform]));let ct=w(N,[g,Qa,U,ot]),wt=w(N,[g,Ja,U,pt]),lt=w(Ia,[g,re,se,ae,ue]),ht=w(N,[ae,Ka,U,_t]);w(O,[g,ya,xa,_a,oe]),w(O,[g,ka,Ba,da,pe]),w(O,[g,Sa,Ga,ca,_e]);let ce=w(za,[wa.createView(),pa,ee]),mt=w(Fa,[g,ya,xa,ka,Ba,Sa,Ga,_a,da,ca]),Aa=24,we=[],le=[];for(let e=Aa;e<I.length;e++){let s=I[e];we.push(w(sa,[g,s.dwWeight,s.dwBias,s.pwWeight,s.pwBias,U,s.dwUniform])),le.push(w(sa,[U,s.dwWeight,s.dwBias,s.pwWeight,s.pwBias,g,s.dwUniform]))}let Z=new Float32Array(1),V=new Float32Array(1),j=new Float32Array(63);function K(e,s){let i=!0,t=0,a=e.beginComputePass();for(a.setPipeline(nt),a.setBindGroup(0,dt),a.dispatchWorkgroups(Math.ceil(128/8),Math.ceil(128/8),24);t<=Pt;t++){let l=i?C[t]:M[t],h=i?E[t]:H[t],r=T[t];a.setPipeline(r.dwPipeline),a.setBindGroup(0,l),a.dispatchWorkgroups(r.dwDispatchX,r.dwDispatchY,r.dwDispatchZ),a.setPipeline(r.pwPipeline),a.setBindGroup(0,h),a.dispatchWorkgroups(r.pwDispatchX,r.pwDispatchY,r.pwDispatchZ),i=!i}a.end();let f=i?g:U;for(e.copyBufferToBuffer(f,0,Ka,0,3072*64*4),a=e.beginComputePass();t<=kt;t++){let l=i?C[t]:M[t],h=i?E[t]:H[t],r=T[t];a.setPipeline(r.dwPipeline),a.setBindGroup(0,l),a.dispatchWorkgroups(r.dwDispatchX,r.dwDispatchY,r.dwDispatchZ),a.setPipeline(r.pwPipeline),a.setBindGroup(0,h),a.dispatchWorkgroups(r.pwDispatchX,r.pwDispatchY,r.pwDispatchZ),i=!i}a.end();let d=i?g:U;for(e.copyBufferToBuffer(d,0,Ja,0,3072*32*4),a=e.beginComputePass();t<=Bt;t++){let l=i?C[t]:M[t],h=i?E[t]:H[t],r=T[t];a.setPipeline(r.dwPipeline),a.setBindGroup(0,l),a.dispatchWorkgroups(r.dwDispatchX,r.dwDispatchY,r.dwDispatchZ),a.setPipeline(r.pwPipeline),a.setBindGroup(0,h),a.dispatchWorkgroups(r.pwDispatchX,r.pwDispatchY,r.pwDispatchZ),i=!i}a.end();let v=i?g:U;for(e.copyBufferToBuffer(v,0,Qa,0,1536*16*4),a=e.beginComputePass();t<=Ut;t++){let l=i?C[t]:M[t],h=i?E[t]:H[t],r=T[t];a.setPipeline(r.dwPipeline),a.setBindGroup(0,l),a.dispatchWorkgroups(r.dwDispatchX,r.dwDispatchY,r.dwDispatchZ),a.setPipeline(r.pwPipeline),a.setBindGroup(0,h),a.dispatchWorkgroups(r.pwDispatchX,r.pwDispatchY,r.pwDispatchZ),i=!i}a.setPipeline(ua),a.setBindGroup(0,ct),a.dispatchWorkgroups(Math.ceil(16/8),Math.ceil(16/8),96),a.end(),i=!1,a=e.beginComputePass();{let l=i?C[t]:M[t],h=i?E[t]:H[t],r=T[t];a.setPipeline(r.dwPipeline),a.setBindGroup(0,l),a.dispatchWorkgroups(r.dwDispatchX,r.dwDispatchY,r.dwDispatchZ),a.setPipeline(r.pwPipeline),a.setBindGroup(0,h),a.dispatchWorkgroups(r.pwDispatchX,r.pwDispatchY,r.pwDispatchZ),i=!i,t++}a.setPipeline(ua),a.setBindGroup(0,wt),a.dispatchWorkgroups(Math.ceil(32/8),Math.ceil(32/8),96),a.end(),i=!1,a=e.beginComputePass();{let l=i?C[t]:M[t],h=i?E[t]:H[t],r=T[t];a.setPipeline(r.dwPipeline),a.setBindGroup(0,l),a.dispatchWorkgroups(r.dwDispatchX,r.dwDispatchY,r.dwDispatchZ),a.setPipeline(r.pwPipeline),a.setBindGroup(0,h),a.dispatchWorkgroups(r.pwDispatchX,r.pwDispatchY,r.pwDispatchZ),i=!i,t++}for(a.setPipeline(rt),a.setBindGroup(0,lt),a.dispatchWorkgroups(Math.ceil(32/8),Math.ceil(32/8),48),a.setPipeline(ua),a.setBindGroup(0,ht),a.dispatchWorkgroups(Math.ceil(64/8),Math.ceil(64/8),48),a.end(),i=!1,a=e.beginComputePass();t<Aa;t++){let l=i?C[t]:M[t],h=i?E[t]:H[t],r=T[t];a.setPipeline(r.dwPipeline),a.setBindGroup(0,l),a.dispatchWorkgroups(r.dwDispatchX,r.dwDispatchY,r.dwDispatchZ),a.setPipeline(r.pwPipeline),a.setBindGroup(0,h),a.dispatchWorkgroups(r.pwDispatchX,r.pwDispatchY,r.pwDispatchZ),i=!i}for(;t<I.length;t++){let l=t-Aa,h=i?we[l]:le[l],r=I[t];a.setPipeline(ut),a.setBindGroup(0,h),a.dispatchWorkgroups(r.outW,r.outH,1),i=!i}a.setPipeline(st),a.setBindGroup(0,mt),a.dispatchWorkgroups(1),a.end(),e.copyBufferToBuffer(_a,0,s,0,4),e.copyBufferToBuffer(da,0,s,4,4),e.copyBufferToBuffer(ca,0,s,8,252)}async function J(e){n.queue.writeBuffer(Va,0,e);let s=n.createCommandEncoder();{let t=s.beginComputePass();t.setPipeline($a),t.setBindGroup(0,de),t.dispatchWorkgroups(Math.ceil(256/16),Math.ceil(256/16),3),t.end()}K(s,G),n.queue.submit([s.finish()]),await G.mapAsync(GPUMapMode.READ);let i=new Float32Array(G.getMappedRange());return Z[0]=i[0],V[0]=i[1],j.set(i.subarray(2,65)),G.unmap(),{handflag:new Float32Array(Z),handedness:new Float32Array(V),landmarks:new Float32Array(j)}}async function ft(e){n.queue.copyExternalImageToTexture({source:e},{texture:wa},[256,256]);let s=n.createCommandEncoder();{let t=s.beginComputePass();t.setPipeline(Za),t.setBindGroup(0,ce),t.dispatchWorkgroups(Math.ceil(256/16),Math.ceil(256/16),1),t.end()}K(s,G),n.queue.submit([s.finish()]),await G.mapAsync(GPUMapMode.READ);let i=new Float32Array(G.getMappedRange());return Z[0]=i[0],V[0]=i[1],j.set(i.subarray(2,65)),G.unmap(),{handflag:new Float32Array(Z),handedness:new Float32Array(V),landmarks:new Float32Array(j)}}async function bt(e=50){let s=new Float32Array(196608);for(let a=0;a<5;a++)await J(s);let i=[];for(let a=0;a<e;a++){let f=performance.now();await J(s),i.push(performance.now()-f)}let t=i.reduce((a,f)=>a+f,0)/i.length;return{avgMs:t,fps:1e3/t}}async function gt(e=50){let s=new Float32Array(196608);for(let d=0;d<5;d++)await J(s);let i=[];for(let d=0;d<e;d++){let v=n.createCommandEncoder();{let h=v.beginComputePass();h.setPipeline($a),h.setBindGroup(0,de),h.dispatchWorkgroups(Math.ceil(256/16),Math.ceil(256/16),3),h.end()}K(v,G);let l=performance.now();n.queue.submit([v.finish()]),await n.queue.onSubmittedWorkDone(),i.push(performance.now()-l)}i.sort((d,v)=>d-v);let t=i.reduce((d,v)=>d+v,0)/i.length,a=i[Math.floor(i.length/2)],f=i[0];return{avgMs:t,fps:1e3/t,medianMs:a,minMs:f}}function yt(e){n.queue.copyExternalImageToTexture({source:e},{texture:wa},[256,256]);let s=n.createCommandEncoder();{let i=s.beginComputePass();i.setPipeline(Za),i.setBindGroup(0,ce),i.dispatchWorkgroups(Math.ceil(256/16),Math.ceil(256/16),1),i.end()}K(s,G),n.queue.submit([s.finish()])}return{device:n,run:J,runFromCanvas:ft,benchmark:bt,benchmarkGPU:gt,_device:n,_benchmarkSubmitOnly:yt}}var Dt="https://cdn.jsdelivr.net/npm/@svenflow/micro-handpose@latest/weights";async function St(o={}){let{weightsUrl:_,scoreThreshold:n=.5}=o;if(typeof navigator>"u"||!navigator.gpu)throw new Error("micro-handpose requires WebGPU. Check browser support at https://webgpureport.org");let m=_??Dt,c=m.endsWith("/")?`${m}weights.json`:`${m}/weights.json`,W=m.endsWith("/")?`${m}weights.bin`:`${m}/weights.bin`,[p,D]=await Promise.all([fetch(c),fetch(W)]);if(!p.ok)throw new Error(`Failed to fetch weights metadata: ${p.status}`);if(!D.ok)throw new Error(`Failed to fetch weights binary: ${D.status}`);let A=await p.json(),B=await D.arrayBuffer(),b=Ie(A,B),u=await ze(b),w=null;function x(){return w||(w=new OffscreenCanvas(256,256)),w}async function Q(y){if(y instanceof HTMLCanvasElement||y instanceof OffscreenCanvas||typeof ImageBitmap<"u"&&y instanceof ImageBitmap)return y;let S=x();S.width=256,S.height=256;let k=S.getContext("2d");return y instanceof ImageData?k.putImageData(y,0,0):k.drawImage(y,0,0,256,256),S}function aa(y,S,k){let z=y[0];if(z<n)return null;let ia=S[0]>.5,F=[];for(let L=0;L<21;L++)F.push({x:k[L*3],y:k[L*3+1],z:k[L*3+2]});return{score:z,handedness:ia?"right":"left",landmarks:F}}async function ea(y){let S=await Q(y),k=await u.runFromCanvas(S);return aa(k.handflag,k.handedness,k.landmarks)}function ta(){u.device.destroy(),w=null}return{detect:ea,dispose:ta}}export{St as createHandpose};
