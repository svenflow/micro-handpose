...
`);async function Ca(o,m){let a;if(m)a=m;else{if(!navigator.gpu)throw new Error("WebGPU not supported");let n=await navigator.gpu.requestAdapter();if(!n)throw new Error("No GPU adapter found");a=await n.requestDevice({requiredLimits:{maxStorageBuffersPerShaderStage:Math.min(n.limits.maxStorageBuffersPerShaderStage,8)}})}let U={r:"read-only-storage",s:"storage",u:"uniform"};function x(n){return a.createBindGroupLayout({entries:n.map((e,s)=>e==="t"?{binding:s,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"float"}}:{binding:s,visibility:GPUShaderStage.COMPUTE,buffer:{type:U[e]}})})}let t=GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC,P=GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC,I=GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC,W=GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST;function f(n,e){return a.createBuffer({size:Math.max(n,4),usage:e})}function g(n,e,s){a.queue.writeBuffer(n,e,s)}function A(n){let e=f(n.data.byteLength,t);return g(e,0,n.data),e}let L=Array.from(o.keys());function oe(n){let e=o.get(n);if(!e)throw new Error(`Weight not found: ${n}`);return e}function y(...n){let e=L.find(s=>n.every(H=>s.includes(H)));if(!e)throw new Error(`Weight not found for: ${n.join(", ")}`);return oe(e)}function ie(n){let[,e,s,H]=n.shape,O=new Float32Array(H*25);for(let _=0;_<H;_++)for(let N=0;N<e;N++)for(let ee=0;ee<s;ee++)O[_*25+N*5+ee]=n.data[N*s*H+ee*H+_];return O}function R(n){let[e,,,s]=n.shape,H=new Float32Array(e*s);for(let O=0;O<e;O++)for(let _=0;_<s;_++)H[O*s+_]=n.data[O*s+_];return H}let le=a.createShaderModule({code:ba}),xe=a.createShaderModule({code:wa}),ke=a.createShaderModule({code:ga}),re=a.createShaderModule({code:ya}),G=a.createShaderModule({code:Pa}),Z=a.createShaderModule({code:xa}),ue=a.createShaderModule({code:va}),Ut=a.createShaderModule({code:Ba}),et=x(["r","r","r","r","s","u"]),We=x(["r","r","r","s","u"]),Le=x(["r","r","r","r","r","s","u"]),At=x(["r","r","r","s","u"]),tt=x(["r","r","r","r","s","u"]),ge=x(["r","r","s","u"]),Ke=x(["t","s","u"]),lt=x(["t","s","u"]);function Ue(n,e){return a.createComputePipeline({layout:a.createPipelineLayout({bindGroupLayouts:[n]}),compute:{module:e,entryPoint:"main"}})}let _t=Ue(et,le),Xt=Ue(We,xe),v=Ue(Le,ke),F=Ue(At,re),X=Ue(tt,G),K=Ue(ge,Z),Q=Ue(Ke,ue),he=Ue(lt,Ut),ne=y("conv2d/Conv2D"),$=y("batch_normalization/","conv2d/Conv2D"),ye=y("p_re_lu/"),j=A(ne),be=A($),pe=A(ye),ce=[{dwKey:"depthwise_conv2d/",pwKey:"conv2d_1/",bnKey:"batch_normalization_1/",preluKey:"p_re_lu_1/",inCh:32,outCh:32,stride:1,inH:96},{dwKey:"depthwise_conv2d_1/",pwKey:"conv2d_2/",bnKey:"batch_normalization_2/",preluKey:"p_re_lu_2/",inCh:32,outCh:32,stride:1,inH:96},{dwKey:"depthwise_conv2d_2/",pwKey:"conv2d_3/",bnKey:"batch_normalization_3/",preluKey:"p_re_lu_3/",inCh:32,outCh:32,stride:1,inH:96},{dwKey:"depthwise_conv2d_3/",pwKey:"conv2d_4/",bnKey:"batch_normalization_4/",preluKey:"p_re_lu_4/",inCh:32,outCh:64,stride:2,inH:96},{dwKey:"depthwise_conv2d_4/",pwKey:"conv2d_5/",bnKey:"batch_normalization_5/",preluKey:"p_re_lu_5/",inCh:64,outCh:64,stride:1,inH:48},{dwKey:"depthwise_conv2d_5/",pwKey:"conv2d_6/",bnKey:"batch_normalization_6/",preluKey:"p_re_lu_6/",inCh:64,outCh:64,stride:1,inH:48},{dwKey:"depthwise_conv2d_6/",pwKey:"conv2d_7/",bnKey:"batch_normalization_7/",preluKey:"p_re_lu_7/",inCh:64,outCh:64,stride:1,inH:48},{dwKey:"depthwise_conv2d_7/",pwKey:"conv2d_8/",bnKey:"batch_normalization_8/",preluKey:"p_re_lu_8/",inCh:64,outCh:128,stride:2,inH:48},{dwKey:"depthwise_conv2d_8/",pwKey:"conv2d_9/",bnKey:"batch_normalization_9/",preluKey:"p_re_lu_9/",inCh:128,outCh:128,stride:1,inH:24},{dwKey:"depthwise_conv2d_9/",pwKey:"conv2d_10/",bnKey:"batch_normalization_10/",preluKey:"p_re_lu_10/",inCh:128,outCh:128,stride:1,inH:24},{dwKey:"depthwise_conv2d_10/",pwKey:"conv2d_11/",bnKey:"batch_normalization_11/",preluKey:"p_re_lu_11/",inCh:128,outCh:128,stride:1,inH:24},{dwKey:"depthwise_conv2d_11/",pwKey:"conv2d_12/",bnKey:"batch_normalization_12/",preluKey:"p_re_lu_12/",inCh:128,outCh:256,stride:2,inH:24},{dwKey:"depthwise_conv2d_12/",pwKey:"conv2d_13/",bnKey:"batch_normalization_13/",preluKey:"p_re_lu_13/",inCh:256,outCh:256,stride:1,inH:12},{dwKey:"depthwise_conv2d_13/",pwKey:"conv2d_14/",bnKey:"batch_normalization_14/",preluKey:"p_re_lu_14/",inCh:256,outCh:256,stride:1,inH:12},{dwKey:"depthwise_conv2d_14/",pwKey:"conv2d_15/",bnKey:"batch_normalization_15/",preluKey:"p_re_lu_15/",inCh:256,outCh:256,stride:1,inH:12},{dwKey:"depthwise_conv2d_15/",pwKey:"conv2d_16/",bnKey:"batch_normalization_16/",preluKey:"p_re_lu_16/",inCh:256,outCh:256,stride:2,inH:12},{dwKey:"depthwise_conv2d_16/",pwKey:"conv2d_17/",bnKey:"batch_normalization_17/",preluKey:"p_re_lu_17/",inCh:256,outCh:256,stride:1,inH:6},{dwKey:"depthwise_conv2d_17/",pwKey:"conv2d_18/",bnKey:"batch_normalization_18/",preluKey:"p_re_lu_18/",inCh:256,outCh:256,stride:1,inH:6},{dwKey:"depthwise_conv2d_18/",pwKey:"conv2d_19/",bnKey:"batch_normalization_19/",preluKey:"p_re_lu_19/",inCh:256,outCh:256,stride:1,inH:6}].map(n=>{let e=y(n.dwKey),s=y(n.pwKey),H=y(n.bnKey),O=y(n.preluKey),_=ie(e),N=f(_.byteLength,t);g(N,0,_);let ee=new Float32Array(n.inCh),b=f(ee.byteLength,t);g(b,0,ee);let C=R(s),h=f(C.byteLength,t);g(h,0,C);let D=A(H),l=A(O);return{dwWeightBuf:N,dwBiasBuf:b,pwWeightBuf:h,pwBiasBuf:D,alphaBuf:l,inCh:n.inCh,outCh:n.outCh,stride:n.stride,inH:n.inH}}),Pe=R(y("conv2d_20/Conv2D")),ve=f(Pe.byteLength,t);g(ve,0,Pe);let Ae=A(y("batch_normalization_20/")),Oe=A(y("p_re_lu_20/")),Me={dwWeightBuf:(()=>{let n=ie(y("depthwise_conv2d_19/")),e=f(n.byteLength,t);return g(e,0,n),e})(),dwBiasBuf:(()=>{let n=new Float32Array(256),e=f(n.byteLength,t);return g(e,0,n),e})(),pwWeightBuf:(()=>{let n=R(y("conv2d_21/")),e=f(n.byteLength,t);return g(e,0,n),e})(),pwBiasBuf:A(y("batch_normalization_21/")),alphaBuf:A(y("p_re_lu_21/")),inCh:256,outCh:256,stride:1,inH:12},_e={dwWeightBuf:(()=>{let n=ie(y("depthwise_conv2d_20/")),e=f(n.byteLength,t);return g(e,0,n),e})(),dwBiasBuf:(()=>{let n=new Float32Array(256),e=f(n.byteLength,t);return g(e,0,n),e})(),pwWeightBuf:(()=>{let n=R(y("conv2d_22/Conv2D1")),e=f(n.byteLength,t);return g(e,0,n),e})(),pwBiasBuf:A(y("batch_normalization_22/")),alphaBuf:A(y("p_re_lu_22/")),inCh:256,outCh:256,stride:1,inH:12},De=R(y("conv2d_23/Conv2D")),Ne=f(De.byteLength,t);g(Ne,0,De);let qe=A(y("batch_normalization_23/")),nt=A(y("p_re_lu_23/")),Ye={dwWeightBuf:(()=>{let n=ie(y("depthwise_conv2d_21/")),e=f(n.byteLength,t);return g(e,0,n),e})(),dwBiasBuf:(()=>{let n=new Float32Array(128),e=f(n.byteLength,t);return g(e,0,n),e})(),pwWeightBuf:(()=>{let n=R(y("conv2d_24/")),e=f(n.byteLength,t);return g(e,0,n),e})(),pwBiasBuf:A(y("batch_normalization_24/")),alphaBuf:A(y("p_re_lu_24/")),inCh:128,outCh:128,stride:1,inH:24},Xe={dwWeightBuf:(()=>{let n=ie(y("depthwise_conv2d_22/")),e=f(n.byteLength,t);return g(e,0,n),e})(),dwBiasBuf:(()=>{let n=new Float32Array(128),e=f(n.byteLength,t);return g(e,0,n),e})(),pwWeightBuf:(()=>{let n=R(y("conv2d_25/Conv2D1")),e=f(n.byteLength,t);return g(e,0,n),e})(),pwBiasBuf:A(y("batch_normalization_25/")),alphaBuf:A(y("p_re_lu_25/")),inCh:128,outCh:128,stride:1,inH:24},at=R(y("classifier_palm_16_NO_PRUNING/Conv2D")),it=f(at.byteLength,t);g(it,0,at);let mt=A(y("classifier_palm_16_NO_PRUNING/BiasAdd")),rt=R(y("regressor_palm_16_NO_PRUNING/Conv2D")),Gt=f(rt.byteLength,t);g(Gt,0,rt);let $t=A(y("regressor_palm_16_NO_PRUNING/BiasAdd")),Vt=R(y("classifier_palm_8_NO_PRUNING/Conv2D")),ft=f(Vt.byteLength,t);g(ft,0,Vt);let Ge=A(y("classifier_palm_8_NO_PRUNING/BiasAdd")),St=R(y("regressor_palm_8_NO_PRUNING/Conv2D")),ht=f(St.byteLength,t);g(ht,0,St);let bt=A(y("regressor_palm_8_NO_PRUNING/BiasAdd")),Mt=Math.max(36864*3,9216*64,2304*128,576*256,144*256)*4,we=f(36864*3*4,t),st=f(Mt,P),Zt=f(Mt,P),wt=f(Mt,P),ot=f(576*256*4,P),Ee=f(144*256*4,P|GPUBufferUsage.COPY_DST),$e=f(576*128*4,P|GPUBufferUsage.COPY_DST),J=f(864*4,I),de=f(15552*4,I),He=f(576*2*4,I),ut=f(576*36*4,I),pt=f(864*4,GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST),ct=f(15552*4,GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST),dt=f(576*2*4,GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST),Te=f(576*36*4,GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST),V=a.createTexture({size:[192,192,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT});function M(n,e){return Math.ceil(n/e)}function q(n){let e=f(n.byteLength,W);return g(e,0,n),e}let Dt=q(new Uint32Array([1,3,32,192,192,96,96])),Et=ce.map(n=>{let e=n.stride===2?n.inH/2:n.inH,s=e,H=n.stride===2?1:2,O=n.inCh;return{dw:q(new Uint32Array([1,n.inCh,n.inH,n.inH,e,s,n.stride,H])),pw:q(new Uint32Array([1,n.inCh,n.outCh,e,s,O,n.stride,n.inH,n.inH])),outH:e,outW:s}}),Ht=(()=>{let n=Me,e=n.stride===2?n.inH/2:n.inH,s=n.stride===2?1:2;return{dw:q(new Uint32Array([1,n.inCh,n.inH,n.inH,e,e,n.stride,s])),pw:q(new Uint32Array([1,n.inCh,n.outCh,e,e,n.inCh,n.stride,n.inH,n.inH])),outH:e}})(),Tt=(()=>{let n=_e,e=n.stride===2?n.inH/2:n.inH,s=n.stride===2?1:2;return{dw:q(new Uint32Array([1,n.inCh,n.inH,n.inH,e,e,n.stride,s])),pw:q(new Uint32Array([1,n.inCh,n.outCh,e,e,n.inCh,n.stride,n.inH,n.inH])),outH:e}})(),Wt=(()=>{let n=Ye,e=n.stride===2?n.inH/2:n.inH,s=n.stride===2?1:2;return{dw:q(new Uint32Array([1,n.inCh,n.inH,n.inH,e,e,n.stride,s])),pw:q(new Uint32Array([1,n.inCh,n.outCh,e,e,n.inCh,n.stride,n.inH,n.inH])),outH:e}})(),Lt=(()=>{let n=Xe,e=n.stride===2?n.inH/2:n.inH,s=n.stride===2?1:2;return{dw:q(new Uint32Array([1,n.inCh,n.inH,n.inH,e,e,n.stride,s])),pw:q(new Uint32Array([1,n.inCh,n.outCh,e,e,n.inCh,n.stride,n.inH,n.inH])),outH:e}})(),jt=q(new Uint32Array([1,256,6,6,12,12])),Jt=q(new Uint32Array([1,256,12,12,12,12])),Qt=q(new Uint32Array([1,256,12,12,24,24])),en=q(new Uint32Array([1,128,24,24,24,24])),Rt=q(new Uint32Array([1,256,256,12,12])),tn=q(new Uint32Array([1,256,128,24,24])),Ot=q(new Uint32Array([1,256,6,12,12])),It=q(new Uint32Array([1,256,108,12,12])),nn=q(new Uint32Array([1,128,2,24,24])),an=q(new Uint32Array([1,128,36,24,24])),rn=q(new Uint32Array([192,192,192])),sn=a.createBindGroup({layout:Ke,entries:[{binding:0,resource:V.createView()},{binding:1,resource:{buffer:we}},{binding:2,resource:{buffer:rn}}]}),Ie=null,gt=0,zt=0,Ft=f(32,W);function on(n,e){return Ie&&gt===n&&zt===e||(Ie&&Ie.destroy(),Ie=a.createTexture({size:[n,e,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),gt=n,zt=e),Ie}let un=a.createBindGroup({layout:et,entries:[{binding:0,resource:{buffer:we}},{binding:1,resource:{buffer:j}},{binding:2,resource:{buffer:be}},{binding:3,resource:{buffer:pe}},{binding:4,resource:{buffer:st}},{binding:5,resource:{buffer:Dt}}]});function Be(n,e,s,H,O,_){let N=_.outH,ee=a.createBindGroup({layout:We,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:e.dwWeightBuf}},{binding:2,resource:{buffer:e.dwBiasBuf}},{binding:3,resource:{buffer:wt}},{binding:4,resource:{buffer:_.dw}}]}),b=n.beginComputePass();b.setPipeline(Xt),b.setBindGroup(0,ee),b.dispatchWorkgroups(M(N,8),M(_.outH,8),e.inCh),b.end();let C=a.createBindGroup({layout:Le,entries:[{binding:0,resource:{buffer:wt}},{binding:1,resource:{buffer:O}},{binding:2,resource:{buffer:e.pwWeightBuf}},{binding:3,resource:{buffer:e.pwBiasBuf}},{binding:4,resource:{buffer:e.alphaBuf}},{binding:5,resource:{buffer:H}},{binding:6,resource:{buffer:_.pw}}]}),h=n.beginComputePass();h.setPipeline(v),h.setBindGroup(0,C),h.dispatchWorkgroups(M(N,8),M(_.outH,8),e.outCh),h.end()}function Se(n,e,s,H,O,_,N,ee,b){let C=a.createBindGroup({layout:At,entries:[{binding:0,resource:{buffer:e}},{binding:1,resource:{buffer:s}},{binding:2,resource:{buffer:H}},{binding:3,resource:{buffer:O}},{binding:4,resource:{buffer:_}}]}),h=n.beginComputePass();h.setPipeline(F),h.setBindGroup(0,C),h.dispatchWorkgroups(M(b,8),M(ee,8),N),h.end()}function Ve(n,e,s,H,O,_,N,ee,b,C){let h=a.createBindGroup({layout:tt,entries:[{binding:0,resource:{buffer:e}},{binding:1,resource:{buffer:s}},{binding:2,resource:{buffer:H}},{binding:3,resource:{buffer:O}},{binding:4,resource:{buffer:_}},{binding:5,resource:{buffer:N}}]}),D=n.beginComputePass();D.setPipeline(X),D.setBindGroup(0,h),D.dispatchWorkgroups(M(C,8),M(b,8),ee),D.end()}async function Kt(n){{let l=n.beginComputePass();l.setPipeline(_t),l.setBindGroup(0,un),l.dispatchWorkgroups(M(96,8),M(96,8),32),l.end()}let e=st,s=Zt;for(let l=0;l<ce.length;l++){let B=ce[l];Be(n,B,e,s,e,Et[l]);let te=e;e=s,s=te,l===10&&n.copyBufferToBuffer(e,0,$e,0,576*128*4),l===14&&n.copyBufferToBuffer(e,0,Ee,0,144*256*4)}{let l=a.createBindGroup({layout:ge,entries:[{binding:0,resource:{buffer:e}},{binding:1,resource:{buffer:ot}},{binding:2,resource:{buffer:s}},{binding:3,resource:{buffer:jt}}]}),B=n.beginComputePass();B.setPipeline(K),B.setBindGroup(0,l),B.dispatchWorkgroups(M(12,8),M(12,8),256),B.end()}{let l=e;e=s,s=l}Ve(n,e,ve,Ae,Oe,s,Rt,256,12,12);{let l=e;e=s,s=l}{let l=a.createBindGroup({layout:ge,entries:[{binding:0,resource:{buffer:e}},{binding:1,resource:{buffer:Ee}},{binding:2,resource:{buffer:s}},{binding:3,resource:{buffer:Jt}}]}),B=n.beginComputePass();B.setPipeline(K),B.setBindGroup(0,l),B.dispatchWorkgroups(M(12,8),M(12,8),256),B.end()}{let l=e;e=s,s=l}Be(n,Me,e,s,e,Ht);{let l=e;e=s,s=l}Be(n,_e,e,s,e,Tt);{let l=e;e=s,s=l}Se(n,e,it,mt,J,Ot,6,12,12),Se(n,e,Gt,$t,de,It,108,12,12);{let l=a.createBindGroup({layout:ge,entries:[{binding:0,resource:{buffer:e}},{binding:1,resource:{buffer:ot}},{binding:2,resource:{buffer:s}},{binding:3,resource:{buffer:Qt}}]}),B=n.beginComputePass();B.setPipeline(K),B.setBindGroup(0,l),B.dispatchWorkgroups(M(24,8),M(24,8),256),B.end()}{let l=e;e=s,s=l}Ve(n,e,Ne,qe,nt,s,tn,128,24,24);{let l=e;e=s,s=l}{let l=a.createBindGroup({layout:ge,entries:[{binding:0,resource:{buffer:e}},{binding:1,resource:{buffer:$e}},{binding:2,resource:{buffer:s}},{binding:3,resource:{buffer:en}}]}),B=n.beginComputePass();B.setPipeline(K),B.setBindGroup(0,l),B.dispatchWorkgroups(M(24,8),M(24,8),128),B.end()}{let l=e;e=s,s=l}Be(n,Ye,e,s,e,Wt);{let l=e;e=s,s=l}Be(n,Xe,e,s,e,Lt);{let l=e;e=s,s=l}Se(n,e,ft,Ge,He,nn,2,24,24),Se(n,e,ht,bt,ut,an,36,24,24),a.queue.submit([n.finish()]);let H=a.createCommandEncoder();H.copyBufferToBuffer(J,0,pt,0,864*4),H.copyBufferToBuffer(de,0,ct,0,15552*4),H.copyBufferToBuffer(He,0,dt,0,576*2*4),H.copyBufferToBuffer(ut,0,Te,0,576*36*4),a.queue.submit([H.finish()]),await Promise.all([pt.mapAsync(GPUMapMode.READ),ct.mapAsync(GPUMapMode.READ),dt.mapAsync(GPUMapMode.READ),Te.mapAsync(GPUMapMode.READ)]);let O=new Float32Array(pt.getMappedRange()).slice(),_=new Float32Array(ct.getMappedRange()).slice(),N=new Float32Array(dt.getMappedRange()).slice(),ee=new Float32Array(Te.getMappedRange()).slice();pt.unmap(),ct.unmap(),dt.unmap(),Te.unmap();let b=2016,C=new Float32Array(b),h=new Float32Array(b*18),D=0;for(let l=0;l<12;l++)for(let B=0;B<12;B++)for(let te=0;te<6;te++){C[D]=O[te*144+l*12+B];for(let Ce=0;Ce<18;Ce++){let Ze=te*18+Ce;h[D*18+Ce]=_[Ze*144+l*12+B]}D++}for(let l=0;l<24;l++)for(let B=0;B<24;B++)for(let te=0;te<2;te++){C[D]=N[te*576+l*24+B];for(let Ce=0;Ce<18;Ce++){let Ze=te*18+Ce;h[D*18+Ce]=ee[Ze*576+l*24+B]}D++}return{scores:C,regressors:h}}async function pn(n){a.queue.copyExternalImageToTexture({source:n},{texture:V},[192,192]);let e=a.createCommandEncoder();{let s=e.beginComputePass();s.setPipeline(Q),s.setBindGroup(0,sn),s.dispatchWorkgroups(M(192,16),M(192,16),1),s.end()}return Kt(e)}async function cn(n,e,s){let H=Math.min(192/e,192/s),O=Math.round(e*H),_=Math.round(s*H),N=(192-O)/2,ee=(192-_)/2,b=N/192,C=ee/192,h=on(e,s),D;if(n instanceof HTMLVideoElement||n instanceof HTMLImageElement){let me=new OffscreenCanvas(e,s);me.getContext("2d").drawImage(n,0,0),D=me}else D=n;a.queue.copyExternalImageToTexture({source:D},{texture:h},[e,s]);let l=new ArrayBuffer(32),B=new Uint32Array(l),te=new Float32Array(l);B[0]=e,B[1]=s,B[2]=192,B[3]=0,te[4]=e/O,te[5]=s/_,te[6]=N,te[7]=ee,a.queue.writeBuffer(Ft,0,l);let Ce=a.createBindGroup({layout:lt,entries:[{binding:0,resource:h.createView()},{binding:1,resource:{buffer:we}},{binding:2,resource:{buffer:Ft}}]}),Ze=a.createCommandEncoder();{let me=Ze.beginComputePass();me.setPipeline(he),me.setBindGroup(0,Ce),me.dispatchWorkgroups(M(192,16),M(192,16),1),me.end()}return{output:await Kt(Ze),lbPadX:b,lbPadY:C}}async function Y(n,e){let s=a.createBuffer({size:e*4,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST}),H=a.createCommandEncoder();H.copyBufferToBuffer(n,0,s,0,e*4),a.queue.submit([H.finish()]),await s.mapAsync(GPUMapMode.READ);let O=new Float32Array(s.getMappedRange()).slice();return s.unmap(),s.destroy(),O}async function dn(n){a.queue.copyExternalImageToTexture({source:n},{texture:V},[192,192]);function e(h,D=1e3){let l=h.slice(0,D);return{min:Math.min(...l),max:Math.max(...l),mean:l.reduce((B,te)=>B+te,0)/l.length,nonZero:l.filter(B=>B!==0).length,sample:Array.from(l.slice(0,10))}}let s={},H=q(new Uint32Array([192,192,192])),O=a.createBindGroup({layout:Ke,entries:[{binding:0,resource:V.createView()},{binding:1,resource:{buffer:we}},{binding:2,resource:{buffer:H}}]}),_=a.createCommandEncoder(),N=_.beginComputePass();N.setPipeline(Q),N.setBindGroup(0,O),N.dispatchWorkgroups(M(192,16),M(192,16),1),N.end(),a.queue.submit([_.finish()]),s.input=e(await Y(we,36864*3)),_=a.createCommandEncoder();let ee=a.createBindGroup({layout:et,entries:[{binding:0,resource:{buffer:we}},{binding:1,resource:{buffer:j}},{binding:2,resource:{buffer:be}},{binding:3,resource:{buffer:pe}},{binding:4,resource:{buffer:st}},{binding:5,resource:{buffer:Dt}}]});N=_.beginComputePass(),N.setPipeline(_t),N.setBindGroup(0,ee),N.dispatchWorkgroups(M(96,8),M(96,8),32),N.end(),a.queue.submit([_.finish()]),s.initConv=e(await Y(st,9216*32));let b=st,C=Zt;for(let h=0;h<ce.length;h++){let D=ce[h];_=a.createCommandEncoder(),Be(_,D,b,C,b,Et[h]),a.queue.submit([_.finish()]);let l=b;if(b=C,C=l,h===0||h===3||h===7||h===11||h===14||h===15||h===18){let B=D.stride===2?D.inH/2:D.inH,te=B*B*D.outCh;s[`block${h}`]=e(await Y(b,te))}h===10&&(_=a.createCommandEncoder(),_.copyBufferToBuffer(b,0,$e,0,576*128*4),a.queue.submit([_.finish()])),h===14&&(_=a.createCommandEncoder(),_.copyBufferToBuffer(b,0,Ee,0,144*256*4),a.queue.submit([_.finish()]))}_=a.createCommandEncoder();{let h=q(new Uint32Array([1,256,6,6,12,12])),D=a.createBindGroup({layout:ge,entries:[{binding:0,resource:{buffer:b}},{binding:1,resource:{buffer:ot}},{binding:2,resource:{buffer:C}},{binding:3,resource:{buffer:h}}]}),l=_.beginComputePass();l.setPipeline(K),l.setBindGroup(0,D),l.dispatchWorkgroups(M(12,8),M(12,8),256),l.end()}a.queue.submit([_.finish()]);{let h=b;b=C,C=h}s.fpnUpsample6to12=e(await Y(b,144*256)),_=a.createCommandEncoder(),Ve(_,b,ve,Ae,Oe,C,Rt,256,12,12),a.queue.submit([_.finish()]);{let h=b;b=C,C=h}s.fpn6to12Conv=e(await Y(b,144*256)),s.backbone12Skip=e(await Y(Ee,144*256)),_=a.createCommandEncoder();{let h=q(new Uint32Array([1,256,12,12,12,12])),D=a.createBindGroup({layout:ge,entries:[{binding:0,resource:{buffer:b}},{binding:1,resource:{buffer:Ee}},{binding:2,resource:{buffer:C}},{binding:3,resource:{buffer:h}}]}),l=_.beginComputePass();l.setPipeline(K),l.setBindGroup(0,D),l.dispatchWorkgroups(M(12,8),M(12,8),256),l.end()}a.queue.submit([_.finish()]);{let h=b;b=C,C=h}s.fpnAdd12=e(await Y(b,144*256)),_=a.createCommandEncoder(),Be(_,Me,b,C,b,Ht),a.queue.submit([_.finish()]);{let h=b;b=C,C=h}s.fpn12Block1=e(await Y(b,144*256)),_=a.createCommandEncoder(),Be(_,_e,b,C,b,Tt),a.queue.submit([_.finish()]);{let h=b;b=C,C=h}s.fpn12Block2=e(await Y(b,144*256)),_=a.createCommandEncoder(),Se(_,b,it,mt,J,Ot,6,12,12),a.queue.submit([_.finish()]),s.cls16=e(await Y(J,864)),_=a.createCommandEncoder(),Se(_,b,Gt,$t,de,It,108,12,12),a.queue.submit([_.finish()]),s.reg16=e(await Y(de,15552),500),_=a.createCommandEncoder();{let h=q(new Uint32Array([1,256,12,12,24,24])),D=a.createBindGroup({layout:ge,entries:[{binding:0,resource:{buffer:b}},{binding:1,resource:{buffer:ot}},{binding:2,resource:{buffer:C}},{binding:3,resource:{buffer:h}}]}),l=_.beginComputePass();l.setPipeline(K),l.setBindGroup(0,D),l.dispatchWorkgroups(M(24,8),M(24,8),256),l.end()}a.queue.submit([_.finish()]);{let h=b;b=C,C=h}s.fpnUpsample12to24=e(await Y(b,576*256)),_=a.createCommandEncoder(),Ve(_,b,Ne,qe,nt,C,256,128,24,24),a.queue.submit([_.finish()]);{let h=b;b=C,C=h}s.fpn12to24Conv=e(await Y(b,576*128)),s.backbone24Skip=e(await Y($e,576*128)),_=a.createCommandEncoder();{let h=q(new Uint32Array([1,128,24,24,24,24])),D=a.createBindGroup({layout:ge,entries:[{binding:0,resource:{buffer:b}},{binding:1,resource:{buffer:$e}},{binding:2,resource:{buffer:C}},{binding:3,resource:{buffer:h}}]}),l=_.beginComputePass();l.setPipeline(K),l.setBindGroup(0,D),l.dispatchWorkgroups(M(24,8),M(24,8),128),l.end()}a.queue.submit([_.finish()]);{let h=b;b=C,C=h}s.fpnAdd24=e(await Y(b,576*128)),_=a.createCommandEncoder(),Be(_,Ye,b,C,b,Wt),a.queue.submit([_.finish()]);{let h=b;b=C,C=h}s.fpn24Block1=e(await Y(b,576*128)),_=a.createCommandEncoder(),Be(_,Xe,b,C,b,Lt),a.queue.submit([_.finish()]);{let h=b;b=C,C=h}return s.fpn24Block2=e(await Y(b,576*128)),_=a.createCommandEncoder(),Se(_,b,ft,Ge,He,128,2,24,24),a.queue.submit([_.finish()]),s.cls8=e(await Y(He,576*2)),_=a.createCommandEncoder(),Se(_,b,ht,bt,ut,128,36,24,24),a.queue.submit([_.finish()]),s.reg8=e(await Y(ut,576*36)),s.initWeights=e(await Y(j,100),100),s.initBias=e(await Y(be,32),32),s.cls16Weights=e(await Y(it,100),100),s.cls16Bias=e(await Y(mt,6),6),s.cls8Weights=e(await Y(ft,100),100),s.cls8Bias=e(await Y(Ge,2),2),s.fpn6to12Weights=e(await Y(ve,100),100),s}return{device:a,run:pn,runWithResize:cn,debugRun:dn}}function $a(){let o=[];for(let m=0;m<12;m++)for(let a=0;a<12;a++){let U=(a+.5)/12,x=(m+.5)/12;for(let t=0;t<6;t++)o.push({x:U,y:x})}for(let m=0;m<24;m++)for(let a=0;a<24;a++){let U=(a+.5)/24,x=(m+.5)/24;for(let t=0;t<2;t++)o.push({x:U,y:x})}return o}var ka=$a();function Va(o){return 1/(1+Math.exp(-o))}function En(o,m){let a=[],{scores:U,regressors:x}=o,t=192;for(let P=0;P<ka.length;P++){let I=Va(U[P]);if(I<m)continue;let W=ka[P],f=P*18,g=W.x+x[f+0]/t,A=W.y+x[f+1]/t,L=x[f+2]/t,oe=x[f+3]/t,y=[];for(let ie=0;ie<7;ie++){let R=W.x+x[f+4+ie*2]/t,le=W.y+x[f+4+ie*2+1]/t;y.push([R,le])}a.push({score:I,box:[g,A,L,oe],keypoints:y})}return a}function Hn(o,m){if(o.length===0)return[];let a=[...o].sort((t,P)=>P.score-t.score),U=[],x=new Set;for(let t=0;t<a.length;t++)if(!x.has(t)){U.push(a[t]);for(let P=t+1;P<a.length;P++)x.has(P)||Za(a[t],a[P])>m&&x.add(P)}return U}function Za(o,m){let a=o.box[0]-o.box[2]/2,U=o.box[1]-o.box[3]/2,x=o.box[0]+o.box[2]/2,t=o.box[1]+o.box[3]/2,P=m.box[0]-m.box[2]/2,I=m.box[1]-m.box[3]/2,W=m.box[0]+m.box[2]/2,f=m.box[1]+m.box[3]/2,g=Math.max(a,P),A=Math.max(U,I),L=Math.min(x,W),oe=Math.min(t,f),y=Math.max(0,L-g),ie=Math.max(0,oe-A),R=y*ie,le=(x-a)*(t-U),xe=(W-P)*(f-I),ke=le+xe-R;return ke>0?R/ke:0}function ja(o){let[m,a,U,x]=o.box,t=o.keypoints[0],P=o.keypoints[2],I=P[0]-t[0],W=P[1]-t[1],f=Math.atan2(W,I),A=-Math.PI/2-f,L=Math.max(U,x),y=L*2.6,ie=-.5*L,R=Math.cos(A),le=Math.sin(A),xe=ie*le,ke=ie*R;return{centerX:m+xe,centerY:a+ke,width:y,height:y,rotation:A}}function Ua(o,m={}){let{scoreThreshold:a=.5,nmsThreshold:U=.3,maxHands:x=2}=m;async function t(W){let f=await o.run(W),g=En(f,a);return Hn(g,U).slice(0,x).map(ja)}async function P(W){let f=await o.run(W),g=En(f,a);return Hn(g,U).slice(0,x)}async function I(W,f,g){let{output:A,lbPadX:L,lbPadY:oe}=await o.runWithResize(W,f,g),y=En(A,a);return{detections:Hn(y,U).slice(0,x),lbPadX:L,lbPadY:oe}}return{detect:t,detectRaw:P,detectRawWithResize:I,model:o}}var Tn=["wrist","thumb_cmc","thumb_mcp","thumb_ip","thumb_tip","index_mcp","index_pip","index_dip","index_tip","middle_mcp","middle_pip","middle_dip","middle_tip","ring_mcp","ring_pip","ring_dip","ring_tip","pinky_mcp","pinky_pip","pinky_dip","pinky_tip"];function Wn(o){let m={};for(let a=0;a<Tn.length;a++)m[Tn[a]]=o[a];return m}function Aa(o,m,a){return o.initialized?(o.value=a*m+(1-a)*o.value,o.value):(o.value=m,o.initialized=!0,m)}function Ga(o,m){let a=2*Math.PI*m*o;return a/(a+1)}function Ja(){return{x:{value:0,initialized:!1},dx:{value:0,initialized:!1},lastTime:-1}}function Ln(o,m,a,U,x,t){let P=o.lastTime<0?.03333333333333333:a-o.lastTime;o.lastTime=a;let I=Ga(P,t),W=o.x.initialized?(m-o.x.value)/P:0,f=Aa(o.dx,W,I),g=U+x*Math.abs(f),A=Ga(P,g);return Aa(o.x,m,A)}function Rn(o={}){let{minCutoff:m=.05,beta:a=80,dCutoff:U=1}=o,x=[];function t(W){x.length!==W&&(x=Array.from({length:W},()=>Ja()))}function P(W,f){let g=f??performance.now()/1e3,A=W.length*3;return t(A),W.map((L,oe)=>({x:Ln(x[oe*3],L.x,g,m,a,U),y:Ln(x[oe*3+1],L.y,g,m,a,U),z:Ln(x[oe*3+2],L.z,g,m,a,U)}))}function I(){x=[]}return{apply:P,reset:I}}var Qa="https://cdn.jsdelivr.net/npm/@svenflow/micro-handpose@latest/weights";async function ei(o={}){let{weightsUrl:m,scoreThreshold:a=.5,palmScoreThreshold:U=.5,maxHands:x=3,forceF32:t=!1}=o;if(typeof navigator>"u"||!navigator.gpu)throw new Error("micro-handpose requires WebGPU. Check browser support at https://webgpureport.org");let P=(m??Qa).replace(/\/$/,"")+"/",[I,W,f,g]=await Promise.all([fetch(`${P}weights_f16.json`),fetch(`${P}weights_f16.bin`),fetch(`${P}palm_detection_weights.json`),fetch(`${P}palm_detection_weights.bin`)]);if(!I.ok)throw new Error(`Failed to fetch landmark weights: ${I.status}`);if(!W.ok)throw new Error(`Failed to fetch landmark weights: ${W.status}`);if(!f.ok)throw new Error(`Failed to fetch palm detection weights: ${f.status}`);if(!g.ok)throw new Error(`Failed to fetch palm detection weights: ${g.status}`);let[A,L,oe,y]=await Promise.all([I.json(),W.arrayBuffer(),f.json(),g.arrayBuffer()]),ie=Mn(A,L),R=Mn(oe,y),le=await Dn(ie,{forceF32:t});if(!t){let v=new OffscreenCanvas(256,256),F=v.getContext("2d");F.fillStyle="#886644",F.fillRect(0,0,256,256),F.fillStyle="#cc9966",F.fillRect(50,50,156,156);let X=await le.runFromCanvas(v);X.landmarks.every(Q=>Q===0)&&X.handflag.every(Q=>Q===0)&&(console.warn("[micro-handpose] f16 model produced all-zero output \u2014 recompiling with f32"),le.device.destroy(),le=await Dn(ie,{forceF32:!0}))}let xe=await Ca(R),ke=Ua(xe,{scoreThreshold:U,maxHands:x}),re=[];for(let v=0;v<x;v++)re.push(Rn());let G=0,Z=null,ue=null;function Ut(){return Z||(Z=new OffscreenCanvas(192,192)),Z}function et(){return ue||(ue=new OffscreenCanvas(256,256)),ue}let We=0,Le=0;function At(v,F,X){let K=Ut();K.width=192,K.height=192;let Q=K.getContext("2d");Q.clearRect(0,0,192,192);let he=Math.min(192/F,192/X),ne=Math.round(F*he),$=Math.round(X*he),ye=(192-ne)/2,j=(192-$)/2;if(We=ye/192,Le=j/192,v instanceof ImageData){let be=new OffscreenCanvas(v.width,v.height);be.getContext("2d").putImageData(v,0,0),Q.drawImage(be,ye,j,ne,$)}else Q.drawImage(v,0,0,F,X,ye,j,ne,$);return K}function tt(v){let F=1/(1-2*We),X=1/(1-2*Le);return{score:v.score,box:[(v.box[0]-We)*F,(v.box[1]-Le)*X,v.box[2]*F,v.box[3]*X],keypoints:v.keypoints.map(([K,Q])=>[(K-We)*F,(Q-Le)*X])}}function ge(v,F,X){let K=v.keypoints[0],Q=v.keypoints[2],he=Q[0]-K[0],ne=Q[1]-K[1],$=Math.atan2(-ne,he),j=Math.PI/2-$,[be,pe,Re,ce]=v.box,Pe=Math.max(Re*F,ce*X),ve=0,Ae=-.5*Pe/X,Oe=Math.cos(j),Me=Math.sin(j),_e=be+(ve*Oe-Ae*Me),De=pe+(ve*Me+Ae*Oe),qe=Pe*2.6;return{centerXpx:_e*F,centerYpx:De*X,sizePx:qe,rotation:j}}function Ke(v,F){let X=et();X.width=256,X.height=256;let K=X.getContext("2d");K.clearRect(0,0,256,256);let Q=256/F.sizePx,he=Math.cos(F.rotation),ne=Math.sin(F.rotation),$=he*Q,ye=-ne*Q,j=ne*Q,be=he*Q,pe=-F.centerXpx*$-F.centerYpx*j+128,Re=-F.centerXpx*ye-F.centerYpx*be+128;if(K.setTransform($,ye,j,be,pe,Re),v instanceof ImageData){let ce=new OffscreenCanvas(v.width,v.height);ce.getContext("2d").putImageData(v,0,0),K.drawImage(ce,0,0)}else K.drawImage(v,0,0);return K.setTransform(1,0,0,1,0,0),X}function lt(v){return v instanceof HTMLCanvasElement||v instanceof OffscreenCanvas?[v.width,v.height]:typeof ImageBitmap<"u"&&v instanceof ImageBitmap?[v.width,v.height]:v instanceof ImageData?[v.width,v.height]:v instanceof HTMLVideoElement?[v.videoWidth,v.videoHeight]:v instanceof HTMLImageElement?[v.naturalWidth,v.naturalHeight]:[256,256]}async function Ue(v){let[F,X]=lt(v),{detections:K,lbPadX:Q,lbPadY:he}=await ke.detectRawWithResize(v,F,X);if(We=Q,Le=he,K.length===0){if(G>0)for(let $=0;$<G&&$<re.length;$++)re[$].reset();return G=0,[]}let ne=[];for(let $ of K){let ye=tt($),j=ge(ye,F,X),be=Ke(v,j),pe=await le.runFromCanvas(be),Re=pe.handflag[0];if(Re<a)continue;let ce=pe.handedness[0]>.5,Pe=[],ve=Math.cos(j.rotation),Ae=Math.sin(j.rotation);for(let _e=0;_e<21;_e++){let De=pe.landmarks[_e*3],Ne=pe.landmarks[_e*3+1],qe=pe.landmarks[_e*3+2],nt=(De-.5)*j.sizePx,Ye=(Ne-.5)*j.sizePx,Xe=ve*nt-Ae*Ye+j.centerXpx,at=Ae*nt+ve*Ye+j.centerYpx;Pe.push({x:Xe/F,y:at/X,z:qe})}let Oe=ne.length,Me=Oe<re.length?re[Oe].apply(Pe):Pe;ne.push({score:Re,handedness:ce?"right":"left",landmarks:Me,keypoints:Wn(Me)})}if(ne.length<G)for(let $=ne.length;$<G;$++)$<re.length&&re[$].reset();return G=ne.length,ne}function _t(){le.device.destroy(),xe.device.destroy(),Z=null,ue=null}return{detect:Ue,dispose:_t,_debug:{palmDetector:ke,palmModel:xe,landmarkModel:le,removeLetterbox:tt,detectionToPixelROI:ge,cropHandRegion:Ke}}}export{Tn as LANDMARK_NAMES,ei as createHandpose,Rn as createLandmarkSmoother,Wn as toKeypoints};
